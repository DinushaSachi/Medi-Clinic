...
public class Doc_dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Doc_dashboard.this, CreateClinicActivity.class);
                startActivity(i);
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Doc_dashboard.this, Doc_dashboard.class);
                finish();
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            ...
            clinicAdapter = new ClinicAdapter(Doc_dashboard.this, clinic1);
